...
import { MapPin, Mail, Phone, MessageSquare, CheckCircle } from 'lucide-react'
...
const kontakInfo = [
  {
    icon: MapPin,
    label: 'Alamat',
    value: 'Jl. Klapanunggal Kp. Cibeber II Ds. Cikahuripan, Kec. Klapanunggal, Kab. Bogor, Jawa Barat 16710',
  },
  {
    icon: Mail,
    label: 'Email',
    value: 'ppdaaarulmughni@gmail.com',
    href: 'mailto:ppdaaarulmughni@gmail.com',
  },
  {
    icon: Phone,
    label: 'Telepon',
    value: '(021) 2921 9666',
    href: 'tel:02129219666',
  },
  {
    icon: MessageSquare,
